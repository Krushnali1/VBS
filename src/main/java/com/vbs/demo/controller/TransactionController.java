...
import com.vbs.demo.dto.TrasactionDto;
...
@RestController // communicates with everyone
@CrossOrigin(origins = "*")
public class TransactionController {
    ...
    TransactionRepo transactionRepo;
     @PostMapping("/deposit")
    public String deposit(@RequestBody TrasactionDto obj)
     {
    ...
    public String withdraw(@RequestBody TrasactionDto obj)
    {
        User user = userRepo.findById(obj.getId())
                .orElseThrow(()->new RuntimeException("Not Found"));
        double newBalance = user.getBalance() - obj.getAmount();
